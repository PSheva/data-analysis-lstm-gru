...
# plt.xticks(np.arange(1000,df.shape[0],75))
# plt.xlabel('Date')
# plt.ylabel('Close ($)')
# plt.legend()
# plt.show()
...
# plt.figure(figsize=(20,7))
# plt.plot(df['Date'].values[1700:], df_volume[1700:], color = 'green', label = 'Real Bitcoin Price')
# plt.plot(df['Date'][-predict.shape[0]:].values, predict, color = 'orange', label = 'Predicted Bitcoin Price')
# plt.xticks(np.arange(100,2900,20))
